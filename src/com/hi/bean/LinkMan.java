...
CREATE TABLE `cst_linkman` (
  ...
  CONSTRAINT `FKh9yp1nql5227xxcopuxqx2e7q` FOREIGN KEY (`lkm_cust_id`) REFERENCES `cst_customer` (`cust_id`)
	...
	public void setLkm_id(Long lkm_id) {
		System.out.println("set linkman id");
		this.lkm_id = lkm_id;
	}
	...
	public void setLkm_name(String lkm_name) {
		System.out.println("set linkman name");
	...
	public void setLkm_position(String lkm_position) {
		System.out.println("set linkman position");
	...
	public void setLkm_memo(String lkm_memo) {
		System.out.println("set linkman memo");
	...
	public void setCustomer(Customer customer) {
		System.out.println("set linkman customer");
	...
	public String toString() {
		return "LinkMan [lkm_id=" + lkm_id + ", lkm_name=" + lkm_name + ", lkm_gender=" + lkm_gender + ", lkm_phone="
				...
				+ ", lkm_position=" + lkm_position + ", lkm_memo=" + lkm_memo + ", customer=" + (customer==null?"null":customer.getCust_name()) + "]";
	}
}
